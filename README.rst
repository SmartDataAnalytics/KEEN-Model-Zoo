...
* **readme.rst**: A description of the experiment including the links to the paper and datasets; example can be seen `here <bioinformatics/ComPath/compath_model_01/readme.rst>`_
